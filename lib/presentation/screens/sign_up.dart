                        ...
                        child: Column(
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.all(Radius.circular(30)),
                                  borderSide: BorderSide(color: Color.fromARGB(255, 187, 171, 148)),
                                ),
                              ),
                            ),
                            ...
                            TextFormField(
                              ...
                              obscureText: true,
                              validator: (confirm) {
                                if (confirm == null || confirm.isEmpty || confirm.length < 8) {
                            ...
                            child: CustomAppButton(
                              ...
                              onPress: () {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(content: Text("Bypassing Sign Up API call for testing...")),
                                  );
